...
public interface IFreelanceRepository : IRepository<Freelance>
{
    ...
    Task<Freelance?> GetFreelanceWithServicesByAppUserIdAsync(Guid appUserId,
        CancellationToken cancellationToken = default);

    Task<Freelance?> GetFreelanceWithLanguagesByAppUserIdAsync(Guid appUserId,
        CancellationToken cancellationToken = default);
    ...
    Task UpdateServicesAsync(Freelance freelance, IReadOnlyList<int> serviceIds,
        CancellationToken cancellationToken = default);

    Task UpdateLanguagesAsync(Freelance freelance, IReadOnlyList<int> sourceLanguageIds,
